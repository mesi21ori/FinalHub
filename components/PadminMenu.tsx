...
const menuItems = [
  { path: "/platform-admin", icon: <FaUser />, label: "Profile" },
  { path: "/new-institution", icon: <FaBell />, label: "Notifications" },
  { path: "/user-list", icon: <FaList />, label: "List of Users" },
  { path: "/institution-list", icon: <FaBuilding />, label: "List of Institutions" },
  { path: "/test", icon: <FaClipboardList />, label: "Subscription Plan" },
 
  { path: "/platfromadmin/list-feedback", icon: <FaStar />, label: "Feedbacks" },
];

...
apiRoute.post(async (req: NextApiRequest, res: NextApiResponse) => {
    const { userId, contentId, researcherType, institutionName, positionTitle, proofOfAffiliation, proofOfIdentity, roleExplanation, researchTopic, purposeOfResearch, historicalContentRequested, intendedUse, supportingDocuments, phoneNumber, firstName, lastName, email, gender, } = req.body;
    ...
    try {
        ...
        const accessRequest = await prisma.accessRequest.create({
            data: {
                ...
                researcherType,
                institutionName, // Default researcher type
                positionTitle,
                proofOfAffiliation,
                proofOfIdentity,
                roleExplanation,
                ...
                intendedUse,
                supportingDocuments: filePath, // Save file path if available
                phoneNumber,
                status: 'PENDING',
            },
        });

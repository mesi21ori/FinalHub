...
//         };
//       }
//       return prevUser; // Return prevUser if it's null
//     });
//   };
...
//           />
//           {photoUrl ? (
//             <img src={photoUrl} alt="Selected" className="w-full h-full object-cover rounded-full" />
//           ) : (
//             <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" viewBox="0 0 24 24" fill="#3C2A21">
...
//             email: user?.email,
//             username: user?.username,
//             password: user?.password, // Handle password if provided
//             userId: userId, // Change this to userId
//         });

...
//             type="submit"
//             disabled={isSubmitDisabled}
//             className={`w-full py-2 px-4 rounded-md transition-colors ${isChecked && passwordStrength === "Strong" && isUsernameAvailable
      ...
      <div className="w-full max-w-2xl p-8 bg-[#E5E5CB] shadow-lg rounded-lg flex flex-col mt-16">
        ...
        <form className="flex flex-wrap -mx-2 space-y-4" onSubmit={handleSubmit}>
          <div className="w-full md:w-1/2 px-2">
            ...
            <div className="flex flex-col mb-4">
              <label htmlFor="firstName" className="block text-[#3e251c]">First Name</label>
              <input
                type="text"
                id="firstName"
                value={firstName}
            ...
            <div className="flex flex-col mb-4">
              <label htmlFor="lastName" className="block text-[#3e251c]">Last Name</label>
              <input
                type="text"
                id="lastName"
                value={lastName}
            ...
            <div className="flex flex-col mb-4">
              <label htmlFor="gender" className="block text-[#3e251c]">Gender</label>
              <select
                id="gender"
                value={gender}
            ...
            <div className="flex flex-col mb-4">
              <label htmlFor="dateOfBirth" className="block text-[#3e251c]">Date of Birth</label>
              <input
                type="date"
                id="dateOfBirth"
                value={dateOfBirth}
            ...
            <div className="flex flex-col mb-4">
              <label htmlFor="phoneNumber" className="block text-[#3e251c]">Phone Number</label>
              <input
                type="tel"
                id="phoneNumber"
                value={phoneNumber}
